...
func runBenchmark() {
    printHeader("🚀 JJLISO8601DateFormatter Benchmark - Swift Version (Asura19)")
    print("Repository: https://github.com/Asura19/JJLISO8601DateFormatter")
    print("Date: \(Date())")
    ...
    printResult(name: "JJL (Swift)", time: constructionResults.jjl)
    ...
    for timeZone in [brazilTimeZone, americaTimeZone, gmtTimeZone] {
        ...
        printResult(name: "    JJL (Swift)", time: recentS2D.jjl)
        ...
        printResult(name: "    JJL (Swift)", time: epochS2D.jjl)
    ...
    for timeZone in [brazilTimeZone, americaTimeZone, gmtTimeZone] {
        ...
        printResult(name: "    JJL (Swift)", time: recentD2S.jjl)
        ...
        printResult(name: "    JJL (Swift)", time: epochD2S.jjl)
