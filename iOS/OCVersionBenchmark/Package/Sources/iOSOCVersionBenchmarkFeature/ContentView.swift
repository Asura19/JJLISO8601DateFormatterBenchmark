...
// iOS Benchmark for Original OC version of JJLISO8601DateFormatter
...
public class BenchmarkEngine: ObservableObject {
    ...
    public func runBenchmark() async {
        ...
        log("======================================================================")
        log(" 🚀 JJLISO8601DateFormatter Benchmark - OC Version (michaeleisel)")
        log("======================================================================")
        log("Repository: https://github.com/michaeleisel/JJLISO8601DateFormatter")
        log("Date: \(Date())")
...
public struct ContentView: View {
    ...
    private var headerSection: some View {
        VStack(spacing: 8) {
            ...
            Text("OC Version (michaeleisel)")
                .font(.subheadline)
                .foregroundColor(.secondary)
            
            Link("GitHub Repository", destination: URL(string: "https://github.com/michaeleisel/JJLISO8601DateFormatter")!)
                .font(.caption)
        }
        .padding()
